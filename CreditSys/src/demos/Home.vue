...
//			if(locationHref.indexOf('from')!=-1){//点击分享链接进入首页
//				var paramsValue=locationHref.split('?')[2];
//			}else{
//				var paramsValue=locationHref.split('?')[1];
//			}
//			if(paramsValue.indexOf('&')!=-1){//有其他参数
//					var arr=paramsValue.split('&');
//					var actionValue=arr[0].split('=')[1];
//					if(actionValue=='recommend'){
//					  window.location.href="http://jifenweixin.shinho.net.cn/#/component/"+actionValue+'?'+arr[1]+'&'+arr[2]+'&'+arr[3];//正式
////					  window.location.href="http://uatjifenweixin.shinho.net.cn/#/component/"+actionValue+'?'+arr[1]+'&'+arr[2]+'&'+arr[3];//测试
//					}else{
//						window.location.href="http://jifenweixin.shinho.net.cn/#/component/"+actionValue+'?'+arr[1];//正式
////					  window.location.href="http://uatjifenweixin.shinho.net.cn/#/component/"+actionValue+'?'+arr[1];//测试
//					}
//			}else{//没有其他参数
//					var actionValue=paramsValue.split('=')[1];
//					window.location.href="http://jifenweixin.shinho.net.cn/#/component/"+actionValue;//正式
////					window.location.href="http://uatjifenweixin.shinho.net.cn/#/component/"+actionValue;//测试
//			}
...
//			}
			...
			var paramsValue=locationHref.split('?')[1];
			var actionValue=paramsValue.split('=')[1];
			if(actionValue.indexOf('signsuccess')!=-1){//有|  有activityId 签到成功页面
			  var str=actionValue.substring(11);
//				window.location.href="http://uatjifenweixin.shinho.net.cn/#/component/signsuccess?activityId="+str;//测试
				window.location.href="http://jifenweixin.shinho.net.cn/#/component/signsuccess?activityId="+str;//正式
			}else if(actionValue.indexOf('registeredrecommend')!=-1){//推荐同行注册页面
			  var str=actionValue.substring(19);
//				window.location.href="http://uatjifenweixin.shinho.net.cn/#/component/registeredrecommend?RecommendId="+str;//测试
				window.location.href="http://jifenweixin.shinho.net.cn/#/component/registeredrecommend?RecommendId="+str;//正式
			}else{
//				window.location.href="http://uatjifenweixin.shinho.net.cn/#/component/"+actionValue;//测试
				window.location.href="http://jifenweixin.shinho.net.cn/#/component/"+actionValue;//正式
			}
