...
//	  			  console.log(_this.addressInfo);
      ...
      selectAddress(index,addressId){//选择地址
      	...
      	setTimeout(function(){
      		...
      		}else if(_this.$route.query.source=='tastedraw'){
      			_this.$router.push({path:'/component/shoporder',query:{skudata:_this.skudata,addressId:addressId,source:'tastedraw',orderId:_this.orderId}});
      		}
      	},500)
      },
      creatAddress(){//新建地址
...
//					_this.addressId=parseInt(response.data);
          ...
          if(_this.$route.query.source=='shopcar'){
      			...
      			_this.$router.push({path:'/component/shoporder',query:{skudata:_this.skudata,addressId:_this.addressId,source:'tastedraw',orderId:_this.orderId}});
      		}
				})
      },
      updateAddress(){//更新地址
