...
//					console.log(JSON.stringify(_this.addresslist));
     ...
     switchAddress() {
      	...
      	// 转换省市区id
      	var provinceId = this.homeAddress[0] - 0;
      	var cityId = this.homeAddress[1] - this.num1;
      	var areaId = this.homeAddress[2] - this.num2 - this.num1;
      	// 获取名称
...
//				  console.log(_this.memberInfo);
	        ...
	        var ProvinceId=(_this.memberInfo.ProvinceId+0).toString();
					...
					_this.hotelAddress=[ProvinceId,CityId,AreaId];//酒店区域
					_this.hoteladdress=_this.memberInfo.HotelAddress;//酒店地址
					if(typeof(_this.memberInfo.HomeProvinceId)!="number"){//家庭区域
						_this.homeAddress=["","",""];
					}else{
