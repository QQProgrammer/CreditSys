...
<style>
	...
	.homepage .weui-grid:before { border-right: none; }
	...
	.homepage .weui-grid__icon { width: 35px !important; height: 35px !important; }
	.homepage .weui-grid:after { border-bottom: none; }
	
	.video-box { width: 90%; margin: 0 auto;}
	.video-box img { width: 100%; }
	.homepage .weui-cells { background: none;}
	.homepage .weui-cells:before { border-top: 0px !important; }
	.weui-cells:after { border-bottom: 0px !important; }
	.homepage .weui-cell__ft{color: #adadad;font-size: 12px;}
	.homepage .weui-cell_access .weui-cell__ft:after{border-width: 1px 1px 0 0 !important;}
	.vux-slider > .vux-swiper > .vux-swiper-item > a > .vux-swiper-desc{background: none !important;}
	.homepage .weui-cell{margin-top: 20px;}
	.homepage .weui-cells{margin-top:0 !important;}
