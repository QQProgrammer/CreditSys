...
export default {
  ...
  methods: {
  	menutitle () {
      var enterPath = window.location.hash;
      var enterTitle = '知味·达美活动首页';
      if(enterPath.indexOf('component') > -1) {
        enterTitle = ''
      }
      
      // 配置各页面 title
      if (this.route.path === '/component/shop')                      return '商城'    
      if (this.route.path === '/')                                    return enterTitle
      if (this.route.path === '/component/homepage')                  return '知味·达美活动首页'
      ...
      if (this.route.path === '/component/registercode')              return '注册码'
...
//  this.addECBrowseDetails();
  ...
  computed: {
    ...
    title () {
      // 配置底部导航是否显示
      if (this.route.path === '/' || this.route.path === '/component/personal' || this.route.path==='/component/shop' || this.route.path==='/component/menu' || this.route.path==='/component/productstore'|| this.route.path==='/component/teammember') {
        this.showNavi = true;
...
.weui-tabbar__item .active { background: url('../static/credit/active.png') no-repeat center; background-size: 100%; }
.weui-tabbar__item .menu { background: url('../static/credit/menu.png') no-repeat center; background-size: 100%; }
...
.weui-bar__item_on .active { background: url('../static/credit/active_current.png') no-repeat center; background-size: 100%; }
.weui-bar__item_on .menu { background: url('../static/credit/menu_current.png') no-repeat center; background-size: 100%; }
