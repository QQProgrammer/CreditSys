...
//测试地址(新) 
//let apirootCom  = 'http://shkapi4uat.shinho.net.cn/ecs/common/';    //公共类
//let apirootUser = 'http://shkapi4uat.shinho.net.cn/ecs/user/'  ;    //用户
//let apiroot     = 'http://shkapi4uat.shinho.net.cn/ecs/ec/' ;        //EC
//let apirootSc   = 'http://shkapi4uat.shinho.net.cn/ecs/mall/' ;   //商城
//let apirootInte = 'http://shkapi4uat.shinho.net.cn/ecs/integral/';   //积分卡片
//let apirootAc   = 'http://shkapi4uat.shinho.net.cn/ecs/activity/' ;  //营销活动


//正式上线地址（新）
   let apirootCom  = 'http://kongapi.shinho.net.cn/ecs/common/';
   let apirootUser = 'http://kongapi.shinho.net.cn/ecs/user/';
   let apiroot     = 'http://kongapi.shinho.net.cn/ecs/ec/';
   let apirootSc   = 'http://kongapi.shinho.net.cn/ecs/mall/';
   let apirootInte = 'http://kongapi.shinho.net.cn/ecs/integral/';
   let apirootAc   = 'http://kongapi.shinho.net.cn/ecs/activity/';


export default {
	//--------------------------获取时间戳字符串签名---------------------------------------------
	// 正式
	 getTimestampAndNonceStr:'http://jifenweixin.shinho.net.cn/Wechat/GetTimestampAndNonceStr',//获取时间戳 随机字符串    正式
	 getJsapiTicketSignature:'http://jifenweixin.shinho.net.cn/Wechat/GetJsapiTicketSignature',//获取签名  正式
	 saveWeChatImage:'http://jifenweixin.shinho.net.cn/Wechat/SaveWeChatImage',//将图片上传到服务器  正式
	 getUrl:'http://jifenweixin.shinho.net.cn',//地址 正式
	 appId:'wx9657251bde1a71c4',

	//测试
//	getTimestampAndNonceStr:'http://uatjifenweixin.shinho.net.cn/Wechat/GetTimestampAndNonceStr',//获取时间戳 随机字符串   测试
//	getJsapiTicketSignature:'http://uatjifenweixin.shinho.net.cn/Wechat/GetJsapiTicketSignature',//获取签名  测试
//	saveWeChatImage:'http://uatjifenweixin.shinho.net.cn/Wechat/SaveWeChatImage',//将图片上传到服务器  测试
//	getUrl:'http://uatjifenweixin.shinho.net.cn',//地址 测试
//  appId:'wxa9067ffebe95ca17',
	...
	addECWXTranspondDetails:apiroot+"api/ECBrowse/AddECWXTranspondDetails",//增加页面访问
